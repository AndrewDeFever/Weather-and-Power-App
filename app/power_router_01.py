...
# Timeouts
DIRECT_TIMEOUT_S = 15  # known utility
PROBE_TIMEOUT_S = 8    # per-provider when utility is unknown

# Metadata-only caching (provider health)
HEALTH_TTL_S = 90  # seconds to "cool down" a provider after a failure/timeout

SUPPORTED_PROVIDERS = {"OGE", "PSO", "EVERGY", "ONCOR"}
PROBE_ORDER = ("PSO", "OGE", "EVERGY", "ONCOR")  # keep deterministic
